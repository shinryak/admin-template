      ...
      <b-col md="12">
        <b-card header="Traffic &amp; Sales">
            ...
            <b-col sm="12" lg="4">
              ...
              <ul class="horizontal-bars">
                <li>
                  ...
                  <div class="bars">
                    <b-progress height="{}" class="progress-xs" :value="34" variant="info" />
                    <b-progress height="{}" class="progress-xs" :value="78" variant="danger" />
                  </div>
                </li>
                <li>
                  <div class="title">
          ...
          <b-table
            ...
            head-variant="light"
          >
            <template v-slot:head(avatar)="data">
            ...
            <template v-slot:cell(avatar)="item">
              <div class="avatar">
                ...
                <span class="avatar-status" :class="{ 'bg-success': item.value.status == 'success', 'bg-warning': item.value.status == 'warning', 'bg-danger': item.value.status == 'danger', 'bg-secondary': item.value.status == '' }" />
              </div>
            </template>
            ...
            <template v-slot:cell(usage)="item">
              ...
              <b-progress v-model="item.value.value" height="{}" class="progress-xs" :variant="variant(item.value.value)" />
            </template>
...
export default {
  ...
  data () {
    return {
      ...
      tableFields: [
        {
          label: 'Avatar <i class="icon-people"></i>',
          class: 'text-center',
          key: 'avatar'
        },
        {
