    ...
    <div class="animated fadeIn">
        ...
        <b-row>
          <b-col cols="6">
            <div class="text-center my-3">
              <b-btn v-b-tooltip.hover title="I am a tooltip!">
                Hover Me
              </b-btn>
            </div>
          </b-col>
          <b-col cols="6">
            <div class="text-center my-3">
              <b-btn id="tooltipButton-2" variant="primary">
                Button
              </b-btn>
      ...
      >
        ...
        <b-row>
          <b-col md="6" class="py-4 text-center">
            <b-btn id="exButton1" variant="outline-success">
              Live chat
            </b-btn>
          </b-col>
          <b-col md="6" class="py-4 text-center">
            <b-btn id="exButton2" variant="outline-success">
              Html chat
            </b-btn>
          </b-col>
        </b-row>
      ...
      >
        ...
        <div class="text-center">
          <b-btn id="tooltipButton-1" variant="primary">
            I have a tooltip
          </b-btn>
          <br><br>
      ...
      >
        ...
        <div class="d-flex flex-column text-md-center">
          ...
          <div class="p-2">
            <b-btn class="px-1" @click="onOpen">
              Open
            </b-btn>
            <b-btn class="px-1" @click="onClose">
              Close
            </b-btn>
          </div>
      ...
      >
        ...
        <div class="d-flex flex-column text-md-center">
          ...
          <div class="p-2">
            ...
            <b-tooltip ref="tooltip2" :disabled.sync="disabled" target="tooltipButton-disable">
              Hello <strong>World!</strong>
            </b-tooltip>
          </div>
        </div>
