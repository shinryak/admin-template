          ...
          <b-row>
            <b-col sm="12">
              <b-form-group>
                ...
                <b-form-input id="ccnumber" type="text" placeholder="0000 0000 0000 0000" />
              </b-form-group>
            </b-col>
          </b-row>
          <b-row>
            ...
            <b-col sm="4">
              <b-form-group>
                ...
                <b-form-input id="cvv" type="text" placeholder="123" />
              </b-form-group>
            </b-col>
          </b-row>
        </b-card>
      ...
      <b-col sm="6">
        <b-card>
          ...
          <b-form-group>
            ...
            <b-form-input id="company" type="text" placeholder="Enter your company name" />
          </b-form-group>
          <b-form-group>
            <label for="vat">VAT</label>
            <b-form-input id="vat" type="text" placeholder="PL1234567890" />
          </b-form-group>
          <b-form-group>
            <label for="street">Street</label>
            <b-form-input id="street" type="text" placeholder="Enter street name" />
          </b-form-group>
          <b-row>
            <b-col sm="8">
              <b-form-group>
                <label for="city">City</label>
                <b-form-input id="city" type="text" placeholder="Enter your city" />
              </b-form-group>
            </b-col>
            <b-col sm="4">
              <b-form-group>
                <label for="postal-code">Postal Code</label>
                <b-form-input id="postal-code" type="text" placeholder="Postal Code" />
              </b-form-group>
            </b-col>
          </b-row>
          <b-form-group>
            <label for="country">Country</label>
            <b-form-input id="country" type="text" placeholder="Country name" />
          </b-form-group>
        </b-card>
      </b-col>
    </b-row>
      ...
      <b-col md="6">
        <b-card>
          ...
          <b-form-group
            ...
            :horizontal="true"
          >
            <b-form-input id="basicName" type="text" />
          </b-form-group>
          <b-form-group
            label="Static"
            ...
            :horizontal="true"
          >
            <b-form-input id="basicStatic" plaintext type="text" value="Username" />
          </b-form-group>
          <b-form-group
            ...
            :horizontal="true"
          >
            <b-form-input id="basicText" type="text" placeholder="Text" />
          </b-form-group>
          <b-form-group
          ...
          <b-form-group
            ...
            :horizontal="true"
          >
            <b-form-input id="basicPassword" type="password" placeholder="Enter your password" />
          </b-form-group>
          <b-form-group
            ...
            :horizontal="true"
          >
            <b-form-input id="basicInputDisabled" type="text" :disabled="true" placeholder="Disabled" />
          </b-form-group>
          <b-form-group
            label="Textarea"
            ...
            :horizontal="true"
          >
            <b-form-textarea id="basicTextarea" :textarea="true" :rows="9" placeholder="Content.." />
          </b-form-group>
          <b-form-group
            label="Select"
          ...
          <b-form-group
            ...
            horizontal
          >
            <b-form-checkbox-group id="basicCheckboxes" stacked name="Checkboxes" :plain="true" :checked="[2,3]">
          ...
          >
            ...
            >
              ...
              <div class="custom-control custom-radio">
                <input id="customRadio3" type="radio" name="customRadio" class="custom-control-input" value="3">
          ...
          >
            ...
            >
              ...
              <div class="custom-control custom-radio custom-control-inline">
                <input id="customRadioInline3" type="radio" name="customRadioInline1" class="custom-control-input" value="3">
          ...
          >
            <b-form-checkbox-group id="basicCustomCheckboxes" stacked>
              <div class="custom-control custom-checkbox">
                <input id="customChk1" type="checkbox" class="custom-control-input" value="1" checked>
                <label class="custom-control-label" for="customChk1">Option 1</label>
              </div>
              <div class="custom-control custom-checkbox">
                <input id="customChk2" type="checkbox" class="custom-control-input" value="2">
                <label class="custom-control-label" for="customChk2">Option 2</label>
              </div>
              <div class="custom-control custom-checkbox">
                <input id="customChk3" type="checkbox" class="custom-control-input" value="3">
          ...
          >
            <b-form-checkbox-group id="basicInlineCustomCheckboxes">
              <div class="custom-control custom-checkbox custom-control-inline">
                <input id="customInChk1" type="checkbox" class="custom-control-input" value="1">
                <label class="custom-control-label" for="customInChk1">Option 1</label>
              </div>
              <div class="custom-control custom-checkbox custom-control-inline">
                <input id="customInChk2" type="checkbox" class="custom-control-input" value="2" checked>
                <label class="custom-control-label" for="customInChk2">Option 2</label>
              </div>
              <div class="custom-control custom-checkbox custom-control-inline">
                <input id="customInChk3" type="checkbox" class="custom-control-input" value="3">
          ...
          <b-form-group
            ...
            :horizontal="true"
          >
            <b-form-file id="fileInput" :plain="true" />
          </b-form-group>
          <b-form-group
            ...
            :horizontal="true"
          >
            <b-form-file id="fileInputMulti" :plain="true" :multiple="true" />
          </b-form-group>
          <div slot="footer">
        ...
        <b-card>
          ...
          <b-form inline>
            ...
            <b-input id="inlineInput1" type="text" placeholder="Jane Doe" />
            <label class="mx-sm-2" for="inlineInput2">Email: </label>
            <b-input id="inlineInput2" type="email" placeholder="jane.doe@example.com" />
          </b-form>
          <div slot="footer">
            <b-button type="submit" size="sm" variant="primary">
              <i class="fa fa-dot-circle-o" /> Submit
      ...
      <b-col md="6">
        <b-card>
          ...
          <b-form-group
            ...
            :horizontal="true"
          >
            <b-form-input id="horizEmail" type="email" placeholder="Enter Email.." />
          </b-form-group>
          <b-form-group
            label="Password"
            label-for="horizPass"
            ...
            :horizontal="true"
          >
            <b-form-input id="horizPass" type="password" placeholder="Enter Password.." />
          </b-form-group>
          <div slot="footer">
            <b-button type="submit" size="sm" variant="primary">
              <i class="fa fa-dot-circle-o" /> Submit
        ...
        <b-card>
          ...
          <b-form-group
            ...
            description="Please enter your email."
          >
            <b-form-input id="normalEmail" type="email" placeholder="Enter Email.." required />
          </b-form-group>
          <b-form-group
            validated
            label="Password"
            ...
            description="Please enter your password."
          >
            <b-form-input id="normalPass" type="password" placeholder="Enter Password.." required />
          </b-form-group>
          <div slot="footer">
            <b-button type="submit" size="sm" variant="primary">
              <i class="fa fa-dot-circle-o" /> Submit
        ...
        <b-card no-body :no-block="true">
          ...
          <b-card-body>
            <b-row class="form-group">
              <b-col sm="3">
                <b-form-input type="text" placeholder=".col-sm-3" />
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="4">
                <b-form-input type="text" placeholder=".col-sm-4" />
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="5">
                <b-form-input type="text" placeholder=".col-sm-5" />
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="6">
                <b-form-input type="text" placeholder=".col-sm-6" />
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="7">
                <b-form-input type="text" placeholder=".col-sm-7" />
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="8">
                <b-form-input type="text" placeholder=".col-sm-8" />
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="9">
                <b-form-input type="text" placeholder=".col-sm-9" />
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="10">
                <b-form-input type="text" placeholder=".col-sm-10" />
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="11">
                <b-form-input type="text" placeholder=".col-sm-11" />
              </b-col>
            </b-row>
            <b-row class="form-group">
              <b-col sm="12">
                <b-form-input type="text" placeholder=".col-sm-12" />
              </b-col>
            </b-row>
          </b-card-body>
          <div slot="footer">
        ...
        <b-card>
          ...
          <b-form-group
            ...
            :horizontal="true"
          >
            <b-form-input id="smInput" type="text" size="sm" placeholder="size='sm'" />
          </b-form-group>
          <b-form-group
            label="Default input"
            ...
            :horizontal="true"
          >
            <b-form-input id="defaultInput" type="text" placeholder="normal" />
          </b-form-group>
          <b-form-group
            label="Large input"
            label-for="lgInput"
            ...
            :horizontal="true"
          >
            <b-form-input id="lgInput" type="text" size="lg" placeholder="size='lg'" />
          </b-form-group>
          <div slot="footer">
            <b-button type="submit" size="sm" variant="primary">
              <i class="fa fa-dot-circle-o" /> Submit
        ...
        <b-card no-body :no-block="true">
          ...
          <b-card-body>
            <b-form-group>
              ...
              <input id="inputIsValid" type="text" class="form-control is-valid">
            ...
            <b-form-group>
              ...
              <input id="inputIsInvalid" type="text" class="form-control is-invalid">
          ...
          <b-card-body>
            <b-form validated novalidate>
              <b-form-group label-for="inputSuccess2" label="Non-required input">
                <b-form-input id="inputSuccess2" type="text" class="form-control-success" />
                <b-form-valid-feedback>
                  Input is not required.
                </b-form-valid-feedback>
              </b-form-group>
              <b-form-group label-for="inputError2" label="Required input">
                <b-form-input id="inputError2" type="text" class="form-control-warning" required />
                <b-form-valid-feedback>
                  Input provided.
                </b-form-valid-feedback>
                <b-form-invalid-feedback>
        ...
        <b-card>
          ...
          <b-form-group>
            <b-input-group>
              ...
              <b-form-input type="text" placeholder="ex. $1.000.000" />
    ...
    <b-row>
      <b-col md="6">
        <b-card>
          ...
          <b-row class="form-group">
            <b-col md="8">
              <b-form-input type="text" placeholder=".col-md-8" />
            </b-col>
            <b-col md="4">
              <b-form-input type="text" placeholder=".col-md-4" />
            </b-col>
          </b-row>
          <b-row class="form-group">
            <b-col md="7">
              <b-form-input type="text" placeholder=".col-md-7" />
            </b-col>
            <b-col md="5">
              <b-form-input type="text" placeholder=".col-md-5" />
            </b-col>
          </b-row>
          <b-row class="form-group">
            <b-col md="6">
              <b-form-input type="text" placeholder=".col-md-6" />
            </b-col>
            <b-col md="6">
              <b-form-input type="text" placeholder=".col-md-6" />
            </b-col>
          ...
          <div slot="footer">
            ...
            <b-button type="button" size="sm" variant="danger">
              Action
            </b-button>
      ...
      <b-col md="6">
        <b-card>
          ...
          <b-row class="form-group">
            <b-col cols="4">
              <b-form-input type="text" placeholder=".col-4" />
            </b-col>
            <b-col cols="8">
              <b-form-input type="text" placeholder=".col-8" />
            </b-col>
          </b-row>
          <b-row class="form-group">
            <b-col cols="5">
              <b-form-input type="text" placeholder=".col-5" />
            </b-col>
            <b-col cols="7">
              <b-form-input type="text" placeholder=".col-7" />
            </b-col>
          </b-row>
          <b-row class="form-group">
            <b-col cols="6">
              <b-form-input type="text" placeholder=".col-6" />
            </b-col>
            <b-col cols="6">
              <b-form-input type="text" placeholder=".col-6" />
            </b-col>
        ...
        <b-card no-body>
          <div slot="header">
            ...
            <div class="card-actions">
              <a href="#" class="btn btn-setting"><i class="icon-settings" /></a>
              <b-btn v-b-toggle.collapse1 class="btn btn-minimize">
                <i class="icon-arrow-up" />
              </b-btn>
              <a href="#" class="btn btn-close"><i class="icon-close" /></a>
            </div>
          </div>
          <b-collapse id="collapse1" visible>
            <b-card-body>
              ...
              <b-form-group label="Two-buttons append" label-for="elementsTwoButtons">
                <b-input-group>
                  <b-form-input id="elementsTwoButtons" type="text" />
                  <b-input-group-append>
                    <b-button variant="primary">
                      Search
                    </b-button>
