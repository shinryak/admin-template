    ...
    <div class="animated fadeIn">
      ...
      >
        ...
        <div>
          ...
          <b-btn class="mt-4" @click="clicked">
            Click me
          </b-btn>
        </div>
      </b-card>
      ...
      >
        ...
        <div>
          <h5>No label</h5>
          <b-progress :value="value" :max="max2" class="mb-3" />
          <h5>Value label</h5>
          <b-progress :value="value" :max="max2" show-value class="mb-3" />
          <h5>Progress label</h5>
          <b-progress :value="value" :max="max2" show-progress class="mb-3" />
          <h5>Value label with precision</h5>
          <b-progress :value="value" :max="max2" :precision="2" show-value class="mb-3" />
          <h5>Progress label with precision</h5>
          <b-progress :value="value" :max="max2" :precision="2" show-progress class="mb-3" />
        </div>
      </b-card>
      <b-card
        header-tag="header"
      ...
      >
        ...
        <div>
          <h5>Default width</h5>
          <b-progress :value="value3" class="mb-3" />
          <h5>Custom widths</h5>
          <b-progress :value="value3" class="w-75 mb-2" />
          <b-progress :value="value3" class="w-50 mb-2" />
          <b-progress :value="value3" class="w-25" />
        </div>
      </b-card>
      <b-card
        header-tag="header"
      ...
      >
        ...
        <div>
          ...
          <b-progress :value="value3" show-progress class="mb-3" />
          <h5>Custom heights</h5>
          <b-progress height="2rem" :value="value3" show-progress class="mb-2" />
          <b-progress height="20px" :value="value3" show-progress class="mb-2" />
          <b-progress height="2px" :value="value3" />
        </div>
      </b-card>
      <b-card
        header-tag="header"
...
export default {
  ...
  methods: {
    clicked () {
      ...
      window.console.log('Change progress to ' +
