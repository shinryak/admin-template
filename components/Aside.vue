<template>
  <aside class="aside-menu h-100">
    <b-tabs content-class="scroll-x aside-tab">
      <b-tab>
        <template slot="title">
          <i class="icon-list" />
        </template>
      ...
      <b-tab>
        ...
        <div class="p-3">
          ...
          <b-progress height="{}" class="progress-xs" variant="danger" :value="95" />
          <small class="text-muted">243GB/256GB</small>
          <div class="text-uppercase mb-1 mt-2">
            <small><b>SSD 2 Usage</b></small>
          </div>
          <b-progress height="{}" class="progress-xs" variant="success" :value="10" />
